...
export default function Home() {
	...
	return (
		<Layout title={'Welcome To ' + process.env.NEXT_PUBLIC_APP_NAME}>
			{ isLoggedIn == true && (
				<div className='main-home-container'>
					...
					<section className="bg-white dark:bg-gray-900">
						<div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
							<div className="max-w-screen-lg text-gray-500 sm:text-lg dark:text-gray-400">
								...
								<Link href="#rmtcontent" className="inline-flex items-center font-medium text-primary-600 hover:text-primary-800 dark:text-primary-500 dark:hover:text-primary-700">
									Learn more
					...
					<section id="rmtcontent" className="bg-white dark:bg-gray-900">
