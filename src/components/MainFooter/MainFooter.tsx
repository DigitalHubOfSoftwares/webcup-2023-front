		...
		<footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
			<div className="mx-auto max-w-screen-xl">
				<div className="md:flex md:justify-between">
					<div className="mb-6 md:mb-0">
						<Link href="https://flowbite.com" className="flex items-center">
							...
							<span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">{ app_name }</span>
						</Link>
					</div>
					<div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
						<div>
							...
							<ul className="text-gray-600 dark:text-gray-400">
								...
								<li className="mb-4">
									<Link href="/" className="hover:underline">Pricing Plan</Link>
								</li>
								{IsLoggedIn == true && (
									<li className="mb-4">
						...
						<div>
							...
							<ul className="text-gray-600 dark:text-gray-400">
								<li className="mb-4">
									<Link href="onirix" className="hover:underline">Onirix</Link>
								</li>
							</ul>
						</div>
						<div>
							<h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Disclamer</h2>
							<p>
								This is only a prediction. Do contact your Pandit!
							</p>
						</div>
					</div>
				</div>
				...
				<div className="sm:flex sm:items-center sm:justify-between">
					<span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <Link href="https://flowbite.com" className="hover:underline">System Aliens™</Link>. All Rights Reserved.
					</span>
