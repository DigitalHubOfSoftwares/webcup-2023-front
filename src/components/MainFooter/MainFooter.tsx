...
const MainFooter: React.FC<footerProps> = ({ app_name = 'DHS' }) => {
	return (
		<footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
			<div className="mx-auto max-w-screen-xl">
				...
				<div className="sm:flex sm:items-center sm:justify-between">
					<span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <Link href="https://flowbite.com" className="hover:underline">System Aliens™</Link>. All Rights Reserved.
					</span>
