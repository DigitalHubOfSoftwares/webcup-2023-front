	...
	return (
		<section className="relative h-[31rem] overflow-hidden">
				...
				<div className=" relative flex flex-col items-center justify-center z-20 py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
					...
					<Link href="/onirix" className="text-white w-48 h-15 font-bold text-3xl rounded-lg px-6 transition-all ease-in-out delay-50 bg-[#81007f] hover:bg-[#BF13E3]/[.6] hover:rounded-3xl focus:ring-4 focus:ring-primary-300 py-3.5 lg:py-2.5 mr-2 focus:outline-none duration-300">Try Onirix</Link>
