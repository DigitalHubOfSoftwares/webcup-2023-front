			...
			<nav className="bg-[#8f00ff]/[.3] backdrop-blur font-bold border-gray-200 px-1 lg:px-1 py-6">
				<div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
					...
					<div className="flex items-center lg:order-2">
						...
						<Link href="/onirix" className="text-white font-bold rounded-lg text-sm px-4 transition-all ease-in-out delay-50 bg-[#81007f] hover:bg-[#BF13E3]/[.6] hover:rounded-3xl focus:ring-4 focus:ring-primary-300 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none duration-300">Try Onirix</Link>
