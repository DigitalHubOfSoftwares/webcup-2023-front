...
const UnderMaintenance: React.FC<UnderMaintenanceProps> = ({ message = 'We are currently under maintenance.', maintenanceEnd }) => {
	...
	return (
		<section className="bg-white dark:bg-gray-900">
			...
			<div className="absolute flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 z-10">
				...
				<Image className='rounded-2xl' src={'/assets/images/maintenance_logo.jpg'} width={100} height={100} alt='SystemAliens'></Image>
